...
Accuracy adds localized damage, armor effectiveness, weapon balance, and combat context for deeper, more tactical fights. Fully configurable, compatible with modded content, and built for immersive (or not) combat.

The mod can be downloaded here: [nexusmods.com](https://www.nexusmods.com/skyrimspecialedition/mods/187578)
