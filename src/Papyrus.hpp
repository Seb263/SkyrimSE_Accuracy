...
namespace Papyrus
{
	...
	{
		vm->RegisterFunction("GetVersion", "Accuracy", GetVersion);
		vm->RegisterFunction("GetIniValueBool", "Accuracy", GetIniValueBool);
		vm->RegisterFunction("GetIniValueFloat", "Accuracy", GetIniValueFloat);
		vm->RegisterFunction("GetIniValueInt", "Accuracy", GetIniValueInt);
		vm->RegisterFunction("GetIniValueString", "Accuracy", GetIniValueString);
		vm->RegisterFunction("GetDefaultIniValueBool", "Accuracy", GetDefaultIniValueBool);
		vm->RegisterFunction("GetDefaultIniValueFloat", "Accuracy", GetDefaultIniValueFloat);
		vm->RegisterFunction("GetDefaultIniValueInt", "Accuracy", GetDefaultIniValueInt);
		vm->RegisterFunction("GetDefaultIniValueString", "Accuracy", GetDefaultIniValueString);
		vm->RegisterFunction("SetIniValueBool", "Accuracy", SetIniValueBool);
		vm->RegisterFunction("SetIniValueFloat", "Accuracy", SetIniValueFloat);
		vm->RegisterFunction("SetIniValueInt", "Accuracy", SetIniValueInt);
		vm->RegisterFunction("SetIniValueString", "Accuracy", SetIniValueString);
		vm->RegisterFunction("RequestRuntimeUpdate", "Accuracy", RequestRuntimeUpdate);
		vm->RegisterFunction("ShouldIgnoreMaintenanceChecks", "Accuracy", ShouldIgnoreMaintenanceChecks);
		return true;
	}
};
